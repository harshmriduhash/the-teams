...
const faqs = [
  ...
  },
  {
    ...
    content: "The GPTs in Theteams.ai's directory come pre-trained with a strong knowledge base. However, they can also be customized to adapt to specific corporate needs. You can fine-tune their behavior and responses to align with your business requirements."
  },
  {
